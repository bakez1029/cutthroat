...
import { PFilterPipe2 } from './pfilter2.pipe';

@Component({
    templateUrl: 'app/products/product-list2.component.html',
    pipes: [ProductFilterPipe, PFilterPipe2],
    directives: [ROUTER_DIRECTIVES],
})
export class ProductList2Component implements OnInit {
    pageTitle: string = 'Product List Page 2';
