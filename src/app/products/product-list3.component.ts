...
import { PFilterPipe3 } from './pfilter3.pipe';

@Component({
    templateUrl: 'app/products/product-list3.component.html',
    pipes: [ProductFilterPipe, PFilterPipe3],
    directives: [ROUTER_DIRECTIVES],
})
export class ProductList3Component implements OnInit {
    pageTitle: string = 'Product List Page 3';
